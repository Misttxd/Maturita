...
public class World1Events : MonoBehaviour
{
    ...
    private void OnMouseEnter()
    {
        ...
        {
            MapSpriteRenderer.sprite = Resources.Load<Sprite>("MapTextures/Select11");
        }
        else if (FishingMiniGameScript.World2Unlocked == true && FishingMiniGameScript.World3Unlocked == false)
        {
            MapSpriteRenderer.sprite = Resources.Load<Sprite>("MapTextures/Select12");
        }
        else if (FishingMiniGameScript.World2Unlocked == true && FishingMiniGameScript.World3Unlocked == true)
        {
            MapSpriteRenderer.sprite = Resources.Load<Sprite>("MapTextures/Select13");
        }
    }
